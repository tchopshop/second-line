			  		...
			  		<tr>
				  		<td class="wrapper last">
					  		<table class="twelve columns">
						  		<tr>
							  		<td>
								  		<a style="color: #465355; text-decoration: none;" href="<?php echo url('node/' . $params['simplenews_source']->getNode()->nid, array('absolute' => TRUE)); ?>">
    Having trouble reading this email? Click here to see it in your browser.</a>
				  					</td>
